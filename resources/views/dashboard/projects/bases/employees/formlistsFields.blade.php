...
@section('js')
    <script>
                        ...
                        success: async function(result) {
                            ...
                            result.forEach(element => {
                               ...
                               <li class="list-group-item">
                                        ...
                                        <label class="form-check-label" for="${element.id}">${element.slug}</label>
                                    </li> `
                            });
        ...
        async function loweringAndAdd(params) {
            ...
            const {
                ...
                html: `<div class="rou">
                            ...
                            <small id="userId" class="form-text text-muted">informe sua senfa-flip-horizontal</small>
                            </div>
                                                ...
                                                success: function(
                                                    response3) {
                                                        Swal.fire({
                                                            ...
                                                            text: response3.event,
                                                            footer: response3.footer
                                                        })
        ...
        //                     if (response.success) {
        //                         parag = document.createElement("p")
        //                         parag.innerText = response.message
        //                         panel.append(parag)
        ...
        //                 }).then(function() {
        //                     $.ajax({
        //                         url: `${window.location.hostname}/dashboard/ficheiros/${data_replacements.formlist_employee}/signatureField`,
        //                         method: "POST",
        //                         data: data_replacements
        //                     }).done(function(response) {
        //                         if (response.success) {
        ...
        //                             parag.innerText = response.message
        //                             panel.append(parag)
        //                             data_replacements.signature_id = response.signature_id

        //                             url =
        //                                 `${window.location.hostname}/dashboard/ficheiros/${data_replacements.formlist_employee}/ajaxSalveFieldAfterAssign`
        //                             $.ajax({
        //                                 url: url,
        //                                 method: "POST",
        //                                 data: data_replacements
