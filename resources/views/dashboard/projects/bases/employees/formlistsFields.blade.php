...
@section('content_header')
    <div class="btn-group">
        ...
        <button class="btn btn-info" id="device">Checar</button>
    </div>
@stop
                            ...
                            <td class="border text-center border-dark p-0 m-0">
                                ...
                                <div class="dropdown" id="dropdownMenu" with="5px" style="max-height: 10px;"
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenu{{ $key }}">
                                        <button class="dropdown-item bg-info" type="button">Devolução</button>
                                        <button class="dropdown-item bg-success" type="button">Alteração</button>
                                        <button class="dropdown-item bg-danger" type="button">Excluir</button>
                                    </div>
                                </div>
                            </td>
        ...
        function DownloadFile(fileName, url) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var blob = mobileAndTabletCheck() ?  new Blob([data], {type: 'application/pdf'}) : new Blob([data], {
