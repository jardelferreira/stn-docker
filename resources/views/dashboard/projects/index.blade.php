...
@section('content')
                                    ...
                                    <div class="dropdown show">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item bg-info"
                                                href="{{ route('dashboard.projects.edit', $project) }}">Editar
                                                informações</a>
                                            <a class="dropdown-item" href="#">Another action</a>
                                            <a class="dropdown-item bg-danger project-btn"
                                                data-project="{{ $project->uuid }}" onclick="confirmDelete(event)"
                                                href="#">Deletar Projeto</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item px-4 pb-4">
                                    ...
                                    <p class="mb-2 font-weight-bold">Progress <span
                                            class="float-right">{{ $progress }}%</span></p>
    ...
    <script>
        function confirmDelete(event) {
            ...
            console.log($(event.target).attr("data-project"));
            $.ajax({
                url: `${url}/json/project`,
                data: {
                    uuid: $(event.target).attr("data-project")
                },
                success: function(data) {
                    console.log(`retorno: ${data}`)
                    Swal.fire({
                        title: `Deletar ${data.name}?`,
                        text: "Ao deletar esse projeto, todos os dados vinculados a ele será perdido, e não será possível reverter!",
                        icon: 'warning',
