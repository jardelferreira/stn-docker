...
{ 
    ...
    protected $resources = [
        ...
        //end Publico permissions resource
        ...
        //end Documentos permissions resource
        ...
        //end Profissoes permissions resource
        ...
        //end Colaboradores permissions resource
        ...
        //end Filiais permissions resource
        ...
        //end Suprimentos-NFs permissions resource
        ...
        //end Suprimentos-Categorias permissions resource
        ...
        //end Suprimentos-Produtos permissions resource
        ...
        //end Formularios permissions resource
        ...
        //end Acl-Permissões permissions resource
        ...
        //end Acl-Usuários permissions resource
        ["name" => "Acl-Funcoes ", "value" => "Acl-Funções","permissions" =>[
         ...
         //end Acl-Funções permissions resource
        ...
        //end Projetos permissions resource
        ...
        //end Bases permissions resource
        ...
        //end Setores permissions resource
    ...
    public static function createResource(string $resource, $system = false)
    {
        ...
        $permissions = [
            [
                'slug' => 'gerenciar-'.$slug,
                'resource' => $group,
                'name' => 'Gerenciar  '.$group,
                'system' => $system,
            ],
            [
                'slug' => 'visualizar-'.$slug,
                'resource' => $group,
                'name' => 'Vizualizar em '.$group,
                'system' => $system,
            ],
            [
                'slug' => 'criar-'.$slug,
            ...
            [
                'slug' => 'atualizar-'.$slug,
                'resource' => $group,
                'name' => 'Atualizar em '.$group,
                'system' => $system,
            ],
            [
                'slug' => 'deletar-'.$slug,
                'resource' => $group,
                'name' => 'Deletar em '.$group,
                'system' => $system,
            ],
            [
                'slug' => 'administrar-'.$slug,
                'resource' => $group,
                'name' => 'Administrar em '.$group,
                'system' => $system,
            ],
        ];
